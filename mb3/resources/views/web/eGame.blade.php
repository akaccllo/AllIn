                ...
                <section id="lobby" ng-controller="LobbiesCtrl" class="ng-scope">
                    <ul class="game-list">
                        ...
                        <li game-box="" class="qt"><a href="javascript:;"
                                   ...
                                   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif><img src="/web/gameimages/mw.png" /></a></li>
                        @endif

                         @if(in_array('CQ9', $_api_list))
                        <li game-box="" class="qt"><a href="javascript:;"
                                   @if($_member) onclick="javascript:window.open('{{ route('ng.playGame') }}?gametype=cq9&playType=1','','width=1024,height=768')"
                                   @else onclick="return layer.msg('请先登录!',{icon:6})" @endif><img src="/web/gameimages/cq9.png" /></a></li>
                        @endif
