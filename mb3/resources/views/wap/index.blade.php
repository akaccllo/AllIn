...
@if(in_array('MW', $_api_list))
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="{{ route('ng.playGame') }}?gametype=mw&playType=1" target="_blank">
                            {{--<img class="m_isComing" src="{{ asset('/wap/images/m_box-game10.png') }}" alt="">--}}
                ...
                @if(in_array('CQ9', $_api_list))
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="{{ route('ng.playGame') }}?gametype=cq9&playType=1" target="_blank">
                            {{--<img class="m_isComing" src="{{ asset('/wap/images/m_box-game1.png') }}" alt="">--}}
            ...
            <div class="m_wrapper clear">
                ...
                @if(in_array('EG', $_api_list))
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="{{ route('ng.playGame') }}?gametype=eg&playType=3" target="_blank">
                            <img src="{{ asset('/wap/images/m_box-lottory2.png') }}" alt="">
                          <span class="m_box-name">
                            EG彩票
                          </span>
                ...
                @endif
                 ...
                 @if(in_array('VR', $_api_list))
                    <div class="m_box m_box-full">
                        <a class="m_box-link" href="{{ route('ng.playGame') }}?gametype=vr&playType=3">
            ...
            <div class="m_wrapper clear">
                ...
                @endif
                  @if(in_array('GJ', $_api_list))
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="{{ route('ng.playGame') }}?gametype=gj&playType=4" target="_blank">
                            {{--<img class="m_isComing" src="{{ asset('/wap/images/m_isComing.png') }}" alt="">--}}
