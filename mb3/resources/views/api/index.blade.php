...
@if(in_array('MW', $_api_list))
    <div style="width: 100%;height:100px;margin: auto">
        <iframe src="{{ route('ng.game_record') }}?gametype=mw&type=0" width="100%" height="100%" frameborder="0">
...
@if(in_array('CQ9', $_api_list))
    <div style="width: 100%;height:100px;margin: auto">
        <iframe src="{{ route('ng.game_record') }}?gametype=cq9&type=0" width="100%" height="100%" frameborder="0">
...
@if(in_array('VR', $_api_list))
    <div style="width: 100%;height:100px;margin: auto">
        <iframe src="{{ route('ng.game_record') }}?gametype=vr&type=2" width="100%" height="100%" frameborder="0">
...
@if(in_array('EG', $_api_list))
    <div style="width: 100%;height:100px;margin: auto">
        <iframe src="{{ route('ng.game_record') }}?gametype=eg&type=2" width="100%" height="100%" frameborder="0">
...
@if(in_array('GJ', $_api_list))
    <div style="width: 100%;height:100px;margin: auto">
        <iframe src="{{ route('ng.game_record') }}?gametype=gj&type=3" width="100%" height="100%" frameborder="0">
...
@if(in_array('BBIN', $_api_list))
    <div style="width: 100%;height:100px;margin: auto">
        <iframe src="{{ route('ng.game_record') }}?gametype=bbin&type=5" width="100%" height="100%" frameborder="0">
