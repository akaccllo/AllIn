        ...
        <div class="container">
            <div class="register_con">
                ...
                <div class="register_left">
                    ...
                    <div class="line_form">
                        <form method="POST" action="<?php echo e(route('web.post_register_one')); ?>">
                            ...
                            <div class="line">
                                <span class="tit">登录账号</span>
                                    ...
                                    <input class="inp" name="name" value="<?php echo e($register_name); ?>" maxlength="9">
                            ...
                            <div class="line">
                                ...
                                <div class="yzm-img"><a onclick="javascript:re_captcha_re();" ><img src="<?php echo e(URL('kit/captcha/1')); ?>" id="c2c98f0de5a04167a9e427d883690ff67"></a></div>
                                <script>
                ...
                <div class="register_links">
                    <img src="<?php echo e(asset('/web/images/n-reg-bg3a.png')); ?>">
                </div>
            </div>
