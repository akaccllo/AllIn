...
<head>
    ...
    <title><?php echo e(isset($page_title) ? $page_title : "代理后台"); ?></title>
...
<div class="wrapper">
    ...
    <!-- Main Header -->
    <?php echo $__env->make('daili.layouts.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    <!-- Left side column. contains the logo and sidebar -->
    <?php echo $__env->make('daili.layouts.aside', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <!-- Content Wrapper. Contains page content -->
    <div class="content-wrapper">

        <section class="content-header">
            <?php echo $__env->make('daili.layouts.alertMsg', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
        </section>
    ...
    <!-- Main Footer -->
    <?php echo $__env->make('daili.layouts.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
</div>
<!-- ./wrapper -->
