<?php $__env->startSection('content'); ?>
    ...
    <ul class="clear textCenter">
        ...
        ?>
        <?php $__currentLoopData = $mg_gameId; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
                <a href="<?php echo e(route('mg.playGame')); ?>?gametype=<?php echo e($item); ?>&devices=1" class="link-box">
                    <div class="link-box-pic">
                        <img src="<?php echo e(asset('/wap/images/mg')); ?>/<?php echo e($item); ?>.png" alt="">
                    </div>
                    <p class="link-box-txt"><?php echo e($mg_zh[$k]); ?></p>
                </a>
...
<?php echo $__env->make('wap.layouts.list_main', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>