            ...
            <div class="sports w1000">
                <div class="sports_content">
                    ...
                    <?php if(in_array('BBIN', $_api_list)): ?>
                        <a href="javascript:;"
                           <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('bbin.playGame')); ?>?gametype=ball','','width=1024,height=768')"
                    ...
                    <?php if(in_array('IBC', $_api_list)): ?>
                        <a href="javascript:;"
                           <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('ibc.playGame')); ?>','','width=1024,height=768')"
                           <?php else: ?> onclick="return layer.msg('请先登录！',{icon:6})" <?php endif; ?>><img
                                    src="<?php echo e(asset('/web/images/sport2.png')); ?>"></a>
                    <?php endif; ?>
                    <?php if(in_array('SS', $_api_list)): ?>
                        <a href="javascript:;"
                           <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('ss.playGame')); ?>','','width=1024,height=768')"
                           <?php else: ?> onclick="return layer.msg('请先登录！',{icon:6})" <?php endif; ?>><img
