            ...
            <div class="lottery">
                <ul>
                    <?php if(in_array('YC', $_api_list)): ?>
                        <li>
                            <a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=27"
                    ...
                    <?php if(in_array('EG', $_api_list)): ?>
                        <li><a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=eg&playType=3 "
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank"><img
                                        src="<?php echo e(asset('/web/images/EG_LOGO.png')); ?>">
                                <div class="liright"><h2>EG彩票</h2><span>YING LOTTERY</span></div>
                            </a>
                            <a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=eg&playType=3"
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank" class="rulebtn">&nbsp;立即游戏&gt;&gt;</a>
                            <br>
                            <p>应有尽有。官方同步开奖，更高中奖率，感受彩票无限乐趣。</p>
                        </li>
                    ...
                    <?php if(in_array('BBIN', $_api_list)): ?>
                        <li><a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=bbin&playType=3"
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank"><img
                                        src="<?php echo e(asset('/web/images/bbin-lottory.png')); ?>">
                                <div class="liright"><h2>BB彩票</h2><span>BBIN LOTTERY</span></div>
                            </a>
                            <a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=bbin&playType=3"
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank" class="rulebtn">&nbsp;立即游戏&gt;&gt;</a>
                            <br>
                            <p>应有尽有。官方同步开奖，更高中奖率，感受彩票无限乐趣。</p>
                        </li>
                        ...
                        <li><a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=bg&playType=3"
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank"><img
                                        src="<?php echo e(asset('/web/images/bg-lottery.png')); ?>">
                                <div class="liright"><h2>BG彩票</h2><span>BG LOTTERY</span></div>
                            </a>
                            <a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=bg&playType=3"
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank" class="rulebtn">&nbsp;立即游戏&gt;&gt;</a>
                            <br>
                            <p>应有尽有。官方同步开奖，更高中奖率，感受彩票无限乐趣。</p>
                        </li>
                    ...
                    <?php if(in_array('VR', $_api_list)): ?>
                        <li><a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=vr&playType=3"
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank"><img
                                        src="<?php echo e(asset('/web/images/vr-lottory.png')); ?>">
                                <div class="liright"><h2>VR彩票</h2><span>VR LOTTERY</span></div>
                            </a>
                            <a <?php if($_member): ?> href="<?php echo e(route('ng.playGame')); ?>?gametype=vr&playType=3"
                               <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?> target="_blank" class="rulebtn">&nbsp;立即游戏&gt;&gt;</a>
                            <br>
                            <p>应有尽有。官方同步开奖，更高中奖率，感受彩票无限乐趣。</p>
                        </li>
