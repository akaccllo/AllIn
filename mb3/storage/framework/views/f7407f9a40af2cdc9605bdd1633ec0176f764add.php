                ...
                <section id="lobby" ng-controller="LobbiesCtrl" class="ng-scope">
                    <ul class="game-list">
                        ...
                        <li game-box="" class="qt"><a href="javascript:;"
                                   ...
                                   <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>><img src="/web/gameimages/qt.png" /></a></li>
                        <?php endif; ?>

                         <?php if(in_array('MW', $_api_list)): ?>
                        <li game-box="" class="qt"><a href="javascript:;"
                                   <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('ng.playGame')); ?>?gametype=mw&playType=1','','width=1024,height=768')"
                                   <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>><img src="/web/gameimages/mw.png" /></a></li>
                        <?php endif; ?>

                         <?php if(in_array('CQ9', $_api_list)): ?>
                        <li game-box="" class="qt"><a href="javascript:;"
                                   <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('ng.playGame')); ?>?gametype=cq9&playType=1','','width=1024,height=768')"
                                   <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>><img src="/web/gameimages/cq9.png" /></a></li>
                        <?php endif; ?>
