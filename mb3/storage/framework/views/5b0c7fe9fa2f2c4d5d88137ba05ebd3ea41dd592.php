...
<?php if($_system_config->is_alert_on == 0): ?>
    <div id="modal-tit" class="modal modal-login">
        <div class="modal-content" style="width: 650px;height: 414px;padding: 0">
            ...
            <a href="javascript:;">
                <img src="<?php echo e($_system_config->alert_img); ?>" alt="">
            </a>
        </div>
    </div>
    <script>
        ...
        <div>
            <ul class="tai_game-box">
                <li class="game notLast">
                    <a href="<?php echo e(route('web.eGame')); ?>"></a>
                </li>
                <li class="live notLast">
                    <a href="<?php echo e(route('web.liveCasino')); ?>"></a>
                </li>
                <li class="sport notLast">
                    <a href="<?php echo e(route('web.esports')); ?>"></a>
                </li>
                <li class="lottery notLast">
                    <a href="<?php echo e(route('web.lottory')); ?>"></a>
                </li>
                <li class="middle">
                    <a href="<?php echo e($_system_config->app_link); ?>" target="_blank"></a>
                </li>
            </ul>
            ...
            <ul class="tai_home-contact">
                <li class="phone">
                    代理qq：
                    <span><?php echo e($_system_config->qq); ?></span>
                </li>
                <li class="phone">
                    澳门热线：
                    <span><?php echo e($_system_config->phone1); ?></span>
                </li>
                <li class="email">
                    邮箱：
                    <span><?php echo e($_system_config->qq); ?>@qq.com</span>
                </li>
                <li class="kefu">
                    客服中心：
                    <a href="javascript:;"
