...
<div class="userbasic_head">
    ...
    <a href="<?php echo e(route('member.safe_psw')); ?>" class="active">取款密码</a>
    <a href="<?php echo e(route('member.login_psw')); ?>">登录密码</a>
</div>
<div class="userbasic_body">
    <div class="bank_tips">温馨提示：修改后请牢记您的取款密码。</div>
    <div class="line_form">
        <form action="<?php echo e(route('member.update_qk_password')); ?>" method="post">
            <div class="line">
