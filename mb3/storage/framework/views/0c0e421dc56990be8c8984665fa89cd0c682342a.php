<?php $__env->startSection('content'); ?>
    ...
    <div class="userbasic_body">
        ...
        <div class="pay_way_wrap">
            <form action="<?php echo e(route('member.post_qq_pay')); ?>" method="post">
                <div class="pay_way_line">
                    <div class="tit">收款二维码</div>
                    <div class="con">
                        <img src="<?php echo e($_system_config->qq_qrcode); ?>">
                    </div>
                </div>
                <div class="pay_way_line">
                    ...
                    <div class="con">
                        <ul>
                            <li>1、请使用QQ扫描二维码</li>
                            <li>2、请核对收款账号名称为：<?php echo e($_system_config->qq_nickname); ?></li>
