          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="AG"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('nag.playGame')); ?>','','width=1024,height=768')"
        ...
        <?php if(in_array('AG', $_api_list)): ?>
          <li>
            ...
            <div class="xx4">
              <span>AG 女优厅</span>
              <a href="javascript:void(0);" title="AG"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('ag.playGame')); ?>','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
            <div class="xx5"><img src="<?php echo e(asset('/web/images/zhenren/2.png')); ?>"></div>
          </li>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="BBIN"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('bbin.playGame')); ?>?gametype=live','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="MG"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('mg.playGame')); ?>','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="BG"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('bg.playGame')); ?>','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="PT"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('pt.playGame')); ?>?gametype=vbal','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="SA"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('sa.playGame')); ?>','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="GD"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('gd.playGame')); ?>','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="OG"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('og.playGame')); ?>','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
          ...
          <li>
            ...
            <div class="xx4">
              ...
              <a href="javascript:void(0);" title="SUNBET"
                 <?php if($_member): ?> onclick="javascript:window.open('<?php echo e(route('sb.playGame')); ?>','','width=1024,height=768')"
                 <?php else: ?> onclick="return layer.msg('请先登录!',{icon:6})" <?php endif; ?>>进入游戏</a>
            </div>
