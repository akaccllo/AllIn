<?php $__env->startSection('content'); ?>
    ...
    <div class="userbasic_body">
        ...
        <div class="pay_way_wrap">
            <form action="<?php echo e(route('member.post_bank_pay')); ?>" method="post">
                <div class="pay_way_line">
                    ...
                    <div class="con">
                        <?php $__currentLoopData = $bank_card_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <ul>
                                <li>银行名称：<?php echo e(\App\Models\Base::$BANK_TYPE[$item->bank_id]); ?></li>
                                <li>银行卡号：<?php echo e($item->card_no); ?></li>
                                <li>银行户名：<?php echo e($item->username); ?></li>
                                <li>开 户 地：<?php echo e($item->bank_address); ?></li>
                            </ul>
