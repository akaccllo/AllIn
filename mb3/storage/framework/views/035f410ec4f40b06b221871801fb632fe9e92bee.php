...
<div class="userbasic_head">
    ...
    <a href="<?php echo e(route('member.member_drawing')); ?>"  class="active">会员提款</a>
...
<div class="userbasic_body">
    ...
    <div class="line_form">
        <form action="<?php echo e(route('member.drawing')); ?>" method="post">
            <div class="line">
                <span class="tit">开户姓名</span>
                <?php echo e($_member->bank_username); ?>
            ...
            <div class="line">
                ...
                <?php echo e($_member->bank_branch_name); ?>
