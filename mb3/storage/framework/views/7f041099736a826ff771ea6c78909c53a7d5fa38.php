                ...
                <form class="form-horizontal cmxform" name="registerForm" id="form" action="<?php echo e(route('member.update', ['id' => $data->getKey()])); ?>}" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" id="real_name"  placeholder="真实姓名" value="<?php echo e($data->real_name); ?>" />
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="number" class="form-control" id="fs_money" name="fs_money"  value="<?php echo e($data->fs_money); ?>"/>
                            </div>
                        </div>
                        <div class="form-group">
