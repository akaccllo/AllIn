                                        ...
                                        <div class="col-sm-7">
                                            <div id="files77" class="files">
                                                <?php if($data->qq_qrcode): ?>
                                                    <div class="pull-left" style="position:relative;margin: 10px;">
                                                        <a href="<?php echo e($data->qq_qrcode); ?>" target="_blank"><img src="<?php echo e($data->qq_qrcode); ?>" alt="" style="width: 100px;"></a>
                                                        <a href="javascript:;" class="glyphicon glyphicon-remove" style="position: absolute;right: 0;top: 0;" onclick="removeDiv(this)"></a>
                                                        <input type="hidden" name="qq_qrcode" value="<?php echo e($data->qq_qrcode); ?>">
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                            ...
                            <form class="form-horizontal" id="form" action="<?php echo e(route('system_config.update', ['id' => 1])); ?>" method="post">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="sms_token" name="sms_token" placeholder="例：8a8371f730733cf5b22a299a302866666" value="<?php echo e($data->sms_token); ?>"  />
                                        </div>
                                    </div>
                                    <div class="form-group">
