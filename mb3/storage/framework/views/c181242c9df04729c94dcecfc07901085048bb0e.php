        ...
        <form class="form-horizontal">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="api_domain" name="api_domain" placeholder="例：api.888.com" value="<?php echo e($data->api_domain); ?>" disabled />
                    </div>
                </div>
                <div class="form-group">
                    <label for="api_key" class="col-sm-2 control-label">sign_key</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="api_key" name="api_key" placeholder="" value="<?php echo e($data->api_key); ?>" disabled />
                    </div>
                </div>
                <div class="form-group">
                    <label for="api_username" class="col-sm-2 control-label">api_account</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="api_username" name="api_username" placeholder="" value="<?php echo e($data->api_username); ?>" disabled />
                    </div>
                </div>
                <div class="form-group">
                    <label for="api_money" class="col-sm-2 control-label">API MONEY</label>
                    <div class="col-sm-7">
                        <input type="number" class="form-control" id="api_money" name="api_money" min="0" placeholder="" value="<?php echo e($data->api_money); ?>" disabled />
                    </div>
                </div>
            </div><!-- /.box-body -->
        </form>
