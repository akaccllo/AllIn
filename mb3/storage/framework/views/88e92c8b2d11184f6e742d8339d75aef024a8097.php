        ...
        <div class="customer_head_toggle">
            <div class="fl">
                ...
                <select onchange="deposit(0,0)" class="report_option">
                    <option value="0" <?php if($type == 0): ?> selected <?php endif; ?>>存款记录</option>
                    <option value="1" <?php if($type == 1): ?> selected <?php endif; ?>>提款记录</option>
                    <option value="2" <?php if($type == 2): ?> selected <?php endif; ?>>额度转换</option>
                    <option value="3" <?php if($type == 3): ?> selected <?php endif; ?>>游戏记录</option>
                    <option value="4" <?php if($type == 4): ?> selected <?php endif; ?>>红利记录</option>
                </select>
            </div>
            <div class="fr time">
                选择日期：
