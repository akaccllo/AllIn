    ...
    <div class="m_container">
        <div class="m_body">
            ...
            <div class="m_wrapper clear">
                ...
                <?php if(in_array('AG', $_api_list)): ?>
                    <div class="m_box m_box-full">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=ag&playType=2" target="_blank" >
                ...
                <?php if(in_array('SA', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=sa&playType=2" target="_blank" >
                ...
                <?php if(in_array('BBIN', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=bbin&playType=2" target="_blank">
                ...
                <?php if(in_array('BG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=bg&playType=2" target="_blank">
                ...
                <?php endif; ?>
                 <?php if(in_array('GD', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=gd&playType=2" target="_blank">
                            <img src="<?php echo e(asset('/wap/images/m_box-live4.jpg')); ?>" alt="">
                        <span class="m_box-name">
                        GD视讯
                      </span>
                ...
                <?php if(in_array('SUNBET', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=sunbet&playType=2" target="_blank">
				...
				<?php if(in_array('DG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=dg&playType=2" target="_blank">
                ...
                <?php endif; ?>
                 ...
                 <?php if(in_array('ALLBET', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=allbet&playType=2" target="_blank">
                            <img src="<?php echo e(asset('/wap/images/m_box-live3.png')); ?>" alt="">
                        <span class="m_box-name">
                        ALLBET视讯
                      </span>
                ...
                <?php endif; ?>
                 ...
                 <?php if(in_array('LEBO', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=lebo&playType=2" target="_blank">
                            <img src="<?php echo e(asset('/wap/images/m_box-live5.jpg')); ?>" alt="">
                        <span class="m_box-name">
                        LEBO视讯
                      </span>
	            ...
	            <?php if(in_array('OG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=og&playType=2" target="_blank">
                            <img src="<?php echo e(asset('/wap/images/m_box-live2.png')); ?>" alt="">
                        <span class="m_box-name">
                        OG视讯
                      </span>
            ...
            <div class="m_wrapper clear">
                ...
                <?php if(in_array('AG', $_api_list)): ?>
                    <div class="m_box m_box-full">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=ag&playType=1" target="_blank">
                ...
                <?php if(in_array('MG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=mg&playType=1" target="_blank">
                ...
                <?php if(in_array('PT', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=pt&playType=1" target="_blank">
                ...
                <?php if(in_array('BBIN', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=bbin&playType=1" target="_blank">
                ...
                <?php if(in_array('TTG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=ttg&playType=1" target="_blank">
                ...
                <?php endif; ?>
                 <?php if(in_array('GPI', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=gpi&playType=1" target="_blank">
                ...
                <?php endif; ?>
                 <?php if(in_array('SG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=sg&playType=1" target="_blank">
                ...
                <?php endif; ?>
                 <?php if(in_array('PP', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=pp&playType=1" target="_blank">
                ...
                <?php endif; ?>
                 <?php if(in_array('QT', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=qt&playType=1" target="_blank">
...
<?php if(in_array('MW', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=mw&playType=1" target="_blank">
                            
                            <img src="<?php echo e(asset('/wap/images/m_box-game10.png')); ?>" alt="">
                          <span class="m_box-name">
                            MW电子
                          </span>
                        </a>
                ...
                <?php if(in_array('CQ9', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=cq9&playType=1" target="_blank">
                            
                            <img src="<?php echo e(asset('/wap/images/m_box-game1.png')); ?>" alt="">
                          <span class="m_box-name">
                            CQ9电子
                          </span>
                        </a>
            ...
            <?php if(in_array('AG', $_api_list)): ?>
                ...
                <div class="m_wrapper clear" style="display: none;">
                    ...
                    <div class="m_box m_box-full">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=8" target="_blank">
            ...
            <div class="m_wrapper clear">
                ...
                <?php if(in_array('BBIN', $_api_list)): ?>
                    <div class="m_box m_box-full">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=bbin&playType=3" target="_blank">
                ...
                <?php if(in_array('BG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=bg&playType=3" target="_blank">
                ...
                <?php if(in_array('EG', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=eg&playType=3" target="_blank">
                            <img src="<?php echo e(asset('/wap/images/m_box-lottory2.png')); ?>" alt="">
                          <span class="m_box-name">
                            EG彩票
                          </span>
                ...
                <?php endif; ?>
                 ...
                 <?php if(in_array('VR', $_api_list)): ?>
                    <div class="m_box m_box-full">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=vr&playType=3">
            ...
            <div class="m_wrapper clear">
                ...
                <?php if(in_array('BBIN', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=bbin&playType=4" target="_blank">
                ...
                <?php if(in_array('IBC', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=ibc&playType=4" target="_blank">
                ...
                <?php endif; ?>
                 ...
                 <?php if(in_array('SS', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=ss&playType=4" target="_blank">
                            
                            <img src="<?php echo e(asset('/wap/images/m_box-esports-im.png')); ?>" alt="">
                        <span class="m_box-name">
                        三昇体育
                      </span>
                        </a>
                ...
                <?php endif; ?>
                  <?php if(in_array('GJ', $_api_list)): ?>
                    <div class="m_box m_box-half">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=gj&playType=4" target="_blank">
            ...
            <div class="m_wrapper clear">
                <div class="m_category">
				 ...
				 <?php if(in_array('KY', $_api_list)): ?>
                    <div class="m_box m_box-full">
                        <a class="m_box-link" href="<?php echo e(route('ng.playGame')); ?>?gametype=ky&playType=5" target="_blank">
                            <img src="<?php echo e(asset('/wap/images/m_box-game5.png')); ?>" alt="">
                          <span class="m_box-name">
                            开元棋牌
                          </span>
