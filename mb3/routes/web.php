<?php
//全套程序访问 www.allin518.com

Route::group(['domain' => 'admin.allin518.com'],function ($router)
{
    $router->get('/', 'Admin\AuthController@getLogin')->name('admin.init');
});
Route::group(['domain' => 'agent.allin518.com'],function ($router)
{
...
Route::group(['prefix' => 'member','namespace' => 'Member'],function ($router)
{
	...
	Route::group(['domain' => 'agent.allin518.com', 'prefix' => 'daili','namespace' => 'Daili'],function ($router){
...
Route::group(['domain' => 'admin.allin518.com', 'prefix' => 'admin','namespace' => 'Admin'],function ($router){
...
Route::group(['namespace' => 'Api'],function ($router){
	...
	$router->get('ng/game_record', 'NgController@game_record')->name('ng.game_record');
